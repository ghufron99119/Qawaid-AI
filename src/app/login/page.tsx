        ...
        <div className="min-h-[80vh] flex items-center justify-center">
            <div className="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100">
                <div className="text-center mb-8">
                    <h1 className="text-3xl justify-center font-arabic font-bold text-emerald-800 mb-2">تسجيل الدخول</h1>
                    <h2 className="text-xl font-semibold text-gray-800">Welcome Back</h2>
                    <p className="text-gray-500 text-sm mt-2">Sign in to your Qawaid AI account</p>
                </div>
                ...
                <p className="mt-6 text-center text-sm text-gray-600">
                    ...
                    <Link href="/register" className="text-emerald-700 hover:text-emerald-600 font-medium">
                        Register here
                    </Link>
                </p>
            </div>
