                        ...
                        {session ? (
                            <div className="flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="bg-emerald-700 hover:bg-emerald-600 px-3 py-2 rounded-md text-sm font-medium transition-colors"
                                >
                                    Logout
                                </button>
                            </div>
                            ...
                            <div className="flex space-x-4">
                                ...
                                <Link
                                    href="/register"
                                    className="bg-emerald-600 hover:bg-emerald-500 text-white px-3 py-2 rounded-md text-sm font-medium transition-colors shadow-sm"
                                >
                                    Sign Up
                                </Link>
                            </div>
